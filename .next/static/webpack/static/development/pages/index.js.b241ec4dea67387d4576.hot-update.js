...
var getDoggos = function getDoggos() {
  return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('https://api.petfinder.com/v2/animals?size=' + size + '&type=' + type + '&status=' + status, {
    headers: {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(callDoggos());

        case 2:
          res = _context.sent;
          json = res.json();
          return _context.abrupt("return", {
            doggos: json.map(function (entry) {
              return entry.doggo;
            })
          });
...
//# sourceMappingURL=index.js.b241ec4dea67387d4576.hot-update.js.map